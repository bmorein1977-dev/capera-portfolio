...
const roleColors = {
  ...
  manager: "bg-teal-500/10 text-teal-700 dark:text-teal-300 border-teal-500/20",
...
const roleDescriptions = {
  ...
  manager: "Read-only oversight of onboarding, training, competence and compliance for analytics and team management",
